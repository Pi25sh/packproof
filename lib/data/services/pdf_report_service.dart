...
/// PdfReportService generates and saves official Government Form II Inspection Memos in PDF format.
class PdfReportService {
  PdfReportService._();

  /// Generates the official PDF document for an inspection report.
  static Future<Uint8List> generateInspectionPdf(InspectionReport report) async {
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(
                        'LEGAL METROLOGY ENFORCEMENT DEPARTMENT',
                        style: pw.TextStyle(
                          fontSize: 15,
                          fontWeight: pw.FontWeight.bold,
                          color: primaryNavy,
                      ...
                      pw.SizedBox(height: 2),
                      pw.Text(
                        'Package Inspection & Statutory Compliance Memo (Form II)',
            ...
            pw.Row(
              ...
              children: [
                ...
                pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.end,
                  children: [
                    pw.Text('Legal Metrology Inspector', style: pw.TextStyle(fontSize: 9, fontWeight: pw.FontWeight.bold, color: primaryNavy)),
  ...
  static Future<String> savePdfToFile(InspectionReport report) async {
    final sanitizedId = report.caseId.replaceAll(RegExp(r'[^\w\-]'), '_');
    final bytes = await generateInspectionPdf(report);
  ...
  static Future<void> printOrSharePdf(InspectionReport report) async {
